...
define i32 @process_packet(%struct.xdp_md* nocapture readonly) #0 section "xdp_flow" !dbg !92 {
  ...
  br i1 %24, label %463, label %25, !dbg !226
...
; <label>:44:                                     ; preds = %25
  ...
  br i1 %46, label %463, label %47, !dbg !327
...
; <label>:96:                                     ; preds = %77, %94, %92
  ...
  br i1 %100, label %463, label %101, !dbg !345
...
; <label>:102:                                    ; preds = %101
  ...
  br i1 %104, label %463, label %105, !dbg !387
...
; <label>:117:                                    ; preds = %101
  ...
  br i1 %119, label %463, label %120, !dbg !424
...
; <label>:132:                                    ; preds = %128
  ...
  call void @llvm.dbg.value(metadata i32 %354, metadata !663, metadata !DIExpression()), !dbg !671
...
; <label>:350:                                    ; preds = %132, %315
  ...
  %353 = lshr i32 %351, 8, !dbg !766
  %354 = sub i32 %352, %353, !dbg !672
  call void @llvm.dbg.value(metadata i32 %354, metadata !146, metadata !DIExpression()), !dbg !767
  %355 = and i32 %354, 262143, !dbg !768
  call void @llvm.dbg.value(metadata i32 %355, metadata !147, metadata !DIExpression()), !dbg !219
  store i32 %355, i32* %2, align 4, !dbg !769, !tbaa !221
  %356 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @flow_map to i8*), i8* nonnull %20) #3, !dbg !770
  call void @llvm.dbg.value(metadata i8* %356, metadata !105, metadata !DIExpression()), !dbg !771
  %357 = icmp eq i8* %356, null, !dbg !772
  br i1 %357, label %463, label %358, !dbg !774

; <label>:358:                                    ; preds = %350
  %359 = getelementptr inbounds i8, i8* %356, i64 52, !dbg !775
  %360 = bitcast i8* %359 to i32*, !dbg !775
  %361 = load i32, i32* %360, align 4, !dbg !775, !tbaa !776
  %362 = icmp eq i32 %361, 0, !dbg !779
  br i1 %362, label %363, label %383, !dbg !780

; <label>:363:                                    ; preds = %358
  %364 = getelementptr inbounds [29 x i8], [29 x i8]* %4, i64 0, i64 0, !dbg !781
  call void @llvm.lifetime.start.p0i8(i64 29, i8* nonnull %364) #3, !dbg !781
  call void @llvm.dbg.declare(metadata [29 x i8]* %4, metadata !154, metadata !DIExpression()), !dbg !781
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %364, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @process_packet.____fmt.1, i64 0, i64 0), i64 29, i32 1, i1 false), !dbg !781
  %365 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %364, i32 29) #3, !dbg !781
  call void @llvm.lifetime.end.p0i8(i64 29, i8* nonnull %364) #3, !dbg !782
  %366 = bitcast i8* %356 to i32*, !dbg !783
  store i32 %88, i32* %366, align 8, !dbg !784, !tbaa !785
  %367 = getelementptr inbounds i8, i8* %356, i64 4, !dbg !786
  %368 = bitcast i8* %367 to i32*, !dbg !786
  store i32 %87, i32* %368, align 4, !dbg !787, !tbaa !788
  %369 = getelementptr inbounds i8, i8* %356, i64 40, !dbg !789
  %370 = bitcast i8* %369 to i32*, !dbg !789
  store i32 %131, i32* %370, align 8, !dbg !790, !tbaa !791
  %371 = getelementptr inbounds i8, i8* %356, i64 48, !dbg !792
  store i8 %91, i8* %371, align 8, !dbg !793, !tbaa !794
  %372 = call i64 inttoptr (i64 5 to i64 ()*)() #3, !dbg !795
  %373 = getelementptr inbounds i8, i8* %356, i64 64, !dbg !796
  %374 = bitcast i8* %373 to i64*, !dbg !796
  store i64 %372, i64* %374, align 8, !dbg !797, !tbaa !798
  %375 = call i64 inttoptr (i64 5 to i64 ()*)() #3, !dbg !799
  %376 = getelementptr inbounds i8, i8* %356, i64 72, !dbg !800
  %377 = bitcast i8* %376 to i64*, !dbg !800
  store i64 %375, i64* %377, align 8, !dbg !801, !tbaa !802
  %378 = atomicrmw add i32* %360, i32 1 seq_cst, !dbg !803
  %379 = getelementptr inbounds i8, i8* %356, i64 56, !dbg !804
  %380 = bitcast i8* %379 to i64*, !dbg !804
  %381 = sub nsw i64 %14, %18, !dbg !805
  %382 = atomicrmw add i64* %380, i64 %381 seq_cst, !dbg !806
  br label %449, !dbg !807

; <label>:383:                                    ; preds = %358
  %384 = getelementptr inbounds [29 x i8], [29 x i8]* %5, i64 0, i64 0, !dbg !808
  call void @llvm.lifetime.start.p0i8(i64 29, i8* nonnull %384) #3, !dbg !808
  call void @llvm.dbg.declare(metadata [29 x i8]* %5, metadata !161, metadata !DIExpression()), !dbg !808
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %384, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @process_packet.____fmt.2, i64 0, i64 0), i64 29, i32 1, i1 false), !dbg !808
  %385 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %384, i32 29) #3, !dbg !808
  call void @llvm.lifetime.end.p0i8(i64 29, i8* nonnull %384) #3, !dbg !809
  %386 = bitcast i8* %356 to i32*, !dbg !810
  %387 = load i32, i32* %386, align 8, !dbg !810, !tbaa !785
  %388 = icmp eq i32 %387, %88, !dbg !811
  br i1 %388, label %389, label %414, !dbg !812

; <label>:389:                                    ; preds = %383
  %390 = getelementptr inbounds i8, i8* %356, i64 40, !dbg !813
  %391 = bitcast i8* %390 to i32*, !dbg !813
  %392 = load i32, i32* %391, align 8, !dbg !813, !tbaa !791
  %393 = icmp eq i32 %392, %131, !dbg !814
  br i1 %393, label %394, label %414, !dbg !815

; <label>:394:                                    ; preds = %389
  %395 = getelementptr inbounds i8, i8* %356, i64 4, !dbg !816
  %396 = bitcast i8* %395 to i32*, !dbg !816
  %397 = load i32, i32* %396, align 4, !dbg !816, !tbaa !788
  %398 = icmp eq i32 %397, %87, !dbg !817
  br i1 %398, label %399, label %414, !dbg !818

; <label>:399:                                    ; preds = %394
  %400 = getelementptr inbounds i8, i8* %356, i64 48, !dbg !819
  %401 = load i8, i8* %400, align 8, !dbg !819, !tbaa !794
  %402 = icmp eq i8 %401, %91, !dbg !820
  br i1 %402, label %403, label %414, !dbg !821

; <label>:403:                                    ; preds = %399
  %404 = getelementptr inbounds [24 x i8], [24 x i8]* %6, i64 0, i64 0, !dbg !822
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %404) #3, !dbg !822
  call void @llvm.dbg.declare(metadata [24 x i8]* %6, metadata !164, metadata !DIExpression()), !dbg !822
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %404, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @process_packet.____fmt.3, i64 0, i64 0), i64 24, i32 1, i1 false), !dbg !822
  %405 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %404, i32 24) #3, !dbg !822
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %404) #3, !dbg !823
  %406 = atomicrmw add i32* %360, i32 1 seq_cst, !dbg !824
  %407 = getelementptr inbounds i8, i8* %356, i64 56, !dbg !825
  %408 = bitcast i8* %407 to i64*, !dbg !825
  %409 = sub nsw i64 %14, %18, !dbg !826
  %410 = atomicrmw add i64* %408, i64 %409 seq_cst, !dbg !827
  %411 = call i64 inttoptr (i64 5 to i64 ()*)() #3, !dbg !828
  %412 = getelementptr inbounds i8, i8* %356, i64 72, !dbg !829
  %413 = bitcast i8* %412 to i64*, !dbg !829
  store i64 %411, i64* %413, align 8, !dbg !830, !tbaa !802
  br label %449, !dbg !831

; <label>:414:                                    ; preds = %399, %394, %389, %383
  %415 = getelementptr inbounds i8, i8* %356, i64 72, !dbg !832
  %416 = bitcast i8* %415 to i64*, !dbg !832
  %417 = load i64, i64* %416, align 8, !dbg !832, !tbaa !802
  %418 = add i64 %417, 2000000000, !dbg !833
  %419 = call i64 inttoptr (i64 5 to i64 ()*)() #3, !dbg !834
  %420 = icmp ult i64 %418, %419, !dbg !835
  br i1 %420, label %421, label %444, !dbg !836

; <label>:421:                                    ; preds = %414
  %422 = getelementptr inbounds [18 x i8], [18 x i8]* %7, i64 0, i64 0, !dbg !837
  call void @llvm.lifetime.start.p0i8(i64 18, i8* nonnull %422) #3, !dbg !837
  call void @llvm.dbg.declare(metadata [18 x i8]* %7, metadata !171, metadata !DIExpression()), !dbg !837
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %422, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @process_packet.____fmt.4, i64 0, i64 0), i64 18, i32 1, i1 false), !dbg !837
  %423 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %422, i32 18) #3, !dbg !837
  call void @llvm.lifetime.end.p0i8(i64 18, i8* nonnull %422) #3, !dbg !838
  store i32 %88, i32* %386, align 8, !dbg !839, !tbaa !785
  %424 = getelementptr inbounds i8, i8* %356, i64 4, !dbg !840
  %425 = bitcast i8* %424 to i32*, !dbg !840
  store i32 %87, i32* %425, align 4, !dbg !841, !tbaa !788
  %426 = getelementptr inbounds i8, i8* %356, i64 40, !dbg !842
  %427 = bitcast i8* %426 to i32*, !dbg !842
  store i32 %131, i32* %427, align 8, !dbg !843, !tbaa !791
  %428 = getelementptr inbounds i8, i8* %356, i64 48, !dbg !844
  store i8 %91, i8* %428, align 8, !dbg !845, !tbaa !794
  %429 = call i64 inttoptr (i64 5 to i64 ()*)() #3, !dbg !846
  %430 = getelementptr inbounds i8, i8* %356, i64 64, !dbg !847
  %431 = bitcast i8* %430 to i64*, !dbg !847
  store i64 %429, i64* %431, align 8, !dbg !848, !tbaa !798
  %432 = call i64 inttoptr (i64 5 to i64 ()*)() #3, !dbg !849
  store i64 %432, i64* %416, align 8, !dbg !850, !tbaa !802
  %433 = getelementptr inbounds i8, i8* %356, i64 56, !dbg !851
  %434 = bitcast i8* %433 to i64*, !dbg !851
  %435 = load i64, i64* %434, align 8, !dbg !852, !tbaa !853
  %436 = sub i64 0, %435, !dbg !854
  %437 = atomicrmw add i64* %434, i64 %436 seq_cst, !dbg !855
  %438 = load i32, i32* %360, align 4, !dbg !856, !tbaa !776
  %439 = sub i32 0, %438, !dbg !857
  %440 = atomicrmw add i32* %360, i32 %439 seq_cst, !dbg !858
  %441 = sub nsw i64 %14, %18, !dbg !859
  %442 = atomicrmw add i64* %434, i64 %441 seq_cst, !dbg !860
  %443 = atomicrmw add i32* %360, i32 1 seq_cst, !dbg !861
  br label %449, !dbg !862

; <label>:444:                                    ; preds = %414
  %445 = getelementptr inbounds [15 x i8], [15 x i8]* %8, i64 0, i64 0, !dbg !863
  call void @llvm.lifetime.start.p0i8(i64 15, i8* nonnull %445) #3, !dbg !863
  call void @llvm.dbg.declare(metadata [15 x i8]* %8, metadata !179, metadata !DIExpression()), !dbg !863
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %445, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @process_packet.____fmt.5, i64 0, i64 0), i64 15, i32 1, i1 false), !dbg !863
  %446 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %445, i32 15) #3, !dbg !863
  call void @llvm.lifetime.end.p0i8(i64 15, i8* nonnull %445) #3, !dbg !864
  %447 = getelementptr inbounds i8, i8* %356, i64 56, !dbg !865
  %448 = bitcast i8* %447 to i64*, !dbg !865
  br label %449

; <label>:449:                                    ; preds = %403, %444, %421, %363
  %450 = phi i64* [ %408, %403 ], [ %448, %444 ], [ %434, %421 ], [ %380, %363 ], !dbg !865
  %451 = getelementptr inbounds [31 x i8], [31 x i8]* %9, i64 0, i64 0, !dbg !866
  call void @llvm.lifetime.start.p0i8(i64 31, i8* nonnull %451) #3, !dbg !866
  call void @llvm.dbg.declare(metadata [31 x i8]* %9, metadata !185, metadata !DIExpression()), !dbg !866
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %451, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @process_packet.____fmt.6, i64 0, i64 0), i64 31, i32 1, i1 false), !dbg !866
  %452 = load i32, i32* %2, align 4, !dbg !866, !tbaa !221
  call void @llvm.dbg.value(metadata i32 %452, metadata !147, metadata !DIExpression()), !dbg !219
  %453 = load i32, i32* %360, align 4, !dbg !866, !tbaa !776
  %454 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %451, i32 31, i32 %452, i32 %453) #3, !dbg !866
  call void @llvm.lifetime.end.p0i8(i64 31, i8* nonnull %451) #3, !dbg !867
  %455 = getelementptr inbounds [35 x i8], [35 x i8]* %10, i64 0, i64 0, !dbg !865
  call void @llvm.lifetime.start.p0i8(i64 35, i8* nonnull %455) #3, !dbg !865
  call void @llvm.dbg.declare(metadata [35 x i8]* %10, metadata !190, metadata !DIExpression()), !dbg !865
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %455, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @process_packet.____fmt.7, i64 0, i64 0), i64 35, i32 1, i1 false), !dbg !865
  %456 = load i32, i32* %2, align 4, !dbg !865, !tbaa !221
  call void @llvm.dbg.value(metadata i32 %456, metadata !147, metadata !DIExpression()), !dbg !219
  %457 = load i64, i64* %450, align 8, !dbg !865, !tbaa !853
  %458 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %455, i32 35, i32 %456, i64 %457) #3, !dbg !865
  call void @llvm.lifetime.end.p0i8(i64 35, i8* nonnull %455) #3, !dbg !868
  %459 = getelementptr inbounds [15 x i8], [15 x i8]* %11, i64 0, i64 0, !dbg !869
  call void @llvm.lifetime.start.p0i8(i64 15, i8* nonnull %459) #3, !dbg !869
  call void @llvm.dbg.declare(metadata [15 x i8]* %11, metadata !195, metadata !DIExpression()), !dbg !869
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %459, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @process_packet.____fmt.8, i64 0, i64 0), i64 15, i32 1, i1 false), !dbg !869
  %460 = zext i16 %129 to i32, !dbg !869
  %461 = zext i16 %130 to i32, !dbg !869
  %462 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %459, i32 15, i32 %460, i32 %461) #3, !dbg !869
  call void @llvm.lifetime.end.p0i8(i64 15, i8* nonnull %459) #3, !dbg !870
  br label %463, !dbg !871

; <label>:463:                                    ; preds = %32, %29, %117, %102, %44, %350, %96, %25, %1, %449
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %20) #3, !dbg !872
  ret i32 2, !dbg !872
}
...
!766 = !DILocation(line: 27, column: 33, scope: !472, inlinedAt: !711)
!767 = !DILocation(line: 128, column: 8, scope: !92)
!768 = !DILocation(line: 192, column: 14, scope: !441)
!769 = !DILocation(line: 192, column: 7, scope: !441)
!770 = !DILocation(line: 197, column: 6, scope: !92)
!771 = !DILocation(line: 121, column: 22, scope: !92)
!772 = !DILocation(line: 198, column: 8, scope: !773)
!773 = distinct !DILexicalBlock(scope: !92, file: !3, line: 198, column: 7)
!774 = !DILocation(line: 198, column: 7, scope: !92)
!775 = !DILocation(line: 203, column: 10, scope: !157)
!776 = !{!777, !201, i64 52}
!777 = !{!"flow_meta", !201, i64 0, !201, i64 4, !202, i64 8, !202, i64 24, !201, i64 40, !202, i64 44, !202, i64 48, !201, i64 52, !778, i64 56, !778, i64 64, !778, i64 72}
!778 = !{!"long long", !202, i64 0}
!779 = !DILocation(line: 203, column: 16, scope: !157)
!780 = !DILocation(line: 203, column: 7, scope: !92)
!781 = !DILocation(line: 205, column: 7, scope: !155)
!782 = !DILocation(line: 205, column: 7, scope: !156)
!783 = !DILocation(line: 206, column: 7, scope: !156)
!784 = !DILocation(line: 206, column: 11, scope: !156)
!785 = !{!777, !201, i64 0}
!786 = !DILocation(line: 207, column: 8, scope: !156)
!787 = !DILocation(line: 207, column: 12, scope: !156)
!788 = !{!777, !201, i64 4}
!789 = !DILocation(line: 208, column: 8, scope: !156)
!790 = !DILocation(line: 208, column: 14, scope: !156)
!791 = !{!777, !201, i64 40}
!792 = !DILocation(line: 209, column: 8, scope: !156)
!793 = !DILocation(line: 209, column: 17, scope: !156)
!794 = !{!777, !202, i64 48}
!795 = !DILocation(line: 210, column: 24, scope: !156)
!796 = !DILocation(line: 210, column: 6, scope: !156)
!797 = !DILocation(line: 210, column: 22, scope: !156)
!798 = !{!777, !778, i64 64}
!799 = !DILocation(line: 211, column: 25, scope: !156)
!800 = !DILocation(line: 211, column: 6, scope: !156)
!801 = !DILocation(line: 211, column: 23, scope: !156)
!802 = !{!777, !778, i64 72}
!803 = !DILocation(line: 212, column: 5, scope: !156)
!804 = !DILocation(line: 213, column: 28, scope: !156)
!805 = !DILocation(line: 213, column: 45, scope: !156)
!806 = !DILocation(line: 213, column: 3, scope: !156)
!807 = !DILocation(line: 214, column: 4, scope: !156)
!808 = !DILocation(line: 217, column: 3, scope: !162)
!809 = !DILocation(line: 217, column: 3, scope: !163)
!810 = !DILocation(line: 218, column: 9, scope: !167)
!811 = !DILocation(line: 218, column: 13, scope: !167)
!812 = !DILocation(line: 218, column: 22, scope: !167)
!813 = !DILocation(line: 218, column: 28, scope: !167)
!814 = !DILocation(line: 218, column: 34, scope: !167)
!815 = !DILocation(line: 218, column: 45, scope: !167)
!816 = !DILocation(line: 218, column: 51, scope: !167)
!817 = !DILocation(line: 218, column: 55, scope: !167)
!818 = !DILocation(line: 218, column: 64, scope: !167)
!819 = !DILocation(line: 218, column: 70, scope: !167)
!820 = !DILocation(line: 218, column: 79, scope: !167)
!821 = !DILocation(line: 218, column: 6, scope: !163)
!822 = !DILocation(line: 221, column: 4, scope: !165)
!823 = !DILocation(line: 221, column: 4, scope: !166)
!824 = !DILocation(line: 222, column: 4, scope: !166)
!825 = !DILocation(line: 223, column: 29, scope: !166)
!826 = !DILocation(line: 223, column: 46, scope: !166)
!827 = !DILocation(line: 223, column: 4, scope: !166)
!828 = !DILocation(line: 224, column: 26, scope: !166)
!829 = !DILocation(line: 224, column: 7, scope: !166)
!830 = !DILocation(line: 224, column: 24, scope: !166)
!831 = !DILocation(line: 225, column: 3, scope: !166)
!832 = !DILocation(line: 229, column: 10, scope: !174)
!833 = !DILocation(line: 229, column: 27, scope: !174)
!834 = !DILocation(line: 229, column: 40, scope: !174)
!835 = !DILocation(line: 229, column: 38, scope: !174)
!836 = !DILocation(line: 229, column: 7, scope: !175)
!837 = !DILocation(line: 232, column: 5, scope: !172)
!838 = !DILocation(line: 232, column: 5, scope: !173)
!839 = !DILocation(line: 233, column: 12, scope: !173)
!840 = !DILocation(line: 234, column: 10, scope: !173)
!841 = !DILocation(line: 234, column: 14, scope: !173)
!842 = !DILocation(line: 235, column: 10, scope: !173)
!843 = !DILocation(line: 235, column: 16, scope: !173)
!844 = !DILocation(line: 236, column: 10, scope: !173)
!845 = !DILocation(line: 236, column: 19, scope: !173)
!846 = !DILocation(line: 237, column: 26, scope: !173)
!847 = !DILocation(line: 237, column: 8, scope: !173)
!848 = !DILocation(line: 237, column: 24, scope: !173)
!849 = !DILocation(line: 238, column: 27, scope: !173)
!850 = !DILocation(line: 238, column: 25, scope: !173)
!851 = !DILocation(line: 239, column: 30, scope: !173)
!852 = !DILocation(line: 239, column: 42, scope: !173)
!853 = !{!777, !778, i64 56}
!854 = !DILocation(line: 239, column: 37, scope: !173)
!855 = !DILocation(line: 239, column: 5, scope: !173)
!856 = !DILocation(line: 240, column: 42, scope: !173)
!857 = !DILocation(line: 240, column: 37, scope: !173)
!858 = !DILocation(line: 240, column: 5, scope: !173)
!859 = !DILocation(line: 241, column: 47, scope: !173)
!860 = !DILocation(line: 241, column: 5, scope: !173)
!861 = !DILocation(line: 242, column: 5, scope: !173)
!862 = !DILocation(line: 244, column: 4, scope: !173)
!863 = !DILocation(line: 247, column: 5, scope: !180)
!864 = !DILocation(line: 247, column: 5, scope: !181)
!865 = !DILocation(line: 253, column: 2, scope: !191)
!866 = !DILocation(line: 252, column: 2, scope: !186)
!867 = !DILocation(line: 252, column: 2, scope: !92)
!868 = !DILocation(line: 253, column: 2, scope: !92)
!869 = !DILocation(line: 254, column: 4, scope: !196)
!870 = !DILocation(line: 254, column: 4, scope: !92)
!871 = !DILocation(line: 259, column: 2, scope: !92)
!872 = !DILocation(line: 260, column: 1, scope: !92)
